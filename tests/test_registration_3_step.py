...
class TestSwaggerStore:
    ...
    def test_add_user_info(self, reg_auth):
        ...
        info = SwaggerStore(url=URL).add_user_info(user_id=uuid, token=access_token, body=body_user_info,
    ...
    def test_add_new_store(self, reg_auth):
        ...
        uuid, access_token = reg_auth
        response_store = SwaggerStore(url=URL).add_new_store(store=random_store, body=body_store, token=access_token)
    ...
    def test_get_store(self, reg_auth):
        ...
        uuid, access_token = reg_auth
        response_store = SwaggerStore(url=URL).add_new_store(store=random_store, body=body_store, token=access_token)
        response_get_store = SwaggerStore(url=URL).get_store(store=random_store, token=access_token)
    ...
    def test_post_item(self, reg_auth):
        ...
        response_item = SwaggerStore(url=URL).post_item(name_item=random_name_item,
    ...
    def test_get_all_items(self, reg_auth):
        ...
        for i in range(3):
            ...
            response_item = SwaggerStore(url=URL).post_item(name_item=random_name_item,
                                                            body=body_item, token=access_token)
        response_get_all_items = SwaggerStore(url=URL).get_all_items(token=access_token)
